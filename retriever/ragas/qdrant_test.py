...
from retriever.vector_store.qdrant_vector_store import search_similar_chunks
...
class QdrantTest:
    ...
    def test_qdrant(self):
        ...
        # Qdrant 벡터 검색
        query = "아세톤의 권고 용도는?"
        query_vector = model.encode(query, normalize_embeddings=True, show_progress_bar=True)
        vector_results = search_similar_chunks(client, query_vector, ["msds"], 5)
...
if __name__ == "__main__":
    qdrant_test = QdrantTest()
    qdrant_test.test_qdrant()