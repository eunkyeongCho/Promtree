...
<img src="images/page_1_img_1.png" alt="image" width="50" height="27" />
# **물질안전보건자료(MSDS)**
...
| 외관(물리적상태) | 고체 |
| --- | --- |
| 특정 물리적 형태: | Roll of Tape |
| 색 | 무색 |
| 냄새 | Acrylic |
| 냄새 역치 | 자료 없음. |
| pH | 해당없음. |
| 녹는 점/어는 점 | 자료 없음. |
| 끓는 점/ 초기 끓는 점/끓는 범위 | 해당없음. |
| 인화점: | 인화점 없음 |
| 증발 속도 | 해당없음. |
| 가연성 | 해당없음. |
...
| 휘발성 유기물 | 자료 없음. |
| 퍼센트 휘발성 | 자료 없음. |
| VOC Less H2O & Exempt Solvents | 자료 없음. |
| 분자량 | 자료 없음. |
...
| 이름 | 루트 | 종 | 값 자료가 없거나 분류를 위해서 충분치 않음 |
| --- | --- | --- | --- |
| 제품 전체 | 자료없음 | 자료없 음 |  |
...
| 이름 | 루트 | 값 | 종 | 시험결과 | 노출 정도 자료없음 |
| --- | --- | --- | --- | --- | --- |
| 제품 전체 | 자료없음 | 자료가 없거나 분류를 위해서 충분 치 않음 | 자료없음 | 자료없음 |  |
...
| 이름 | 루트 | 종 | 값 |
| --- | --- | --- | --- |
| 제품 전체 | 자료없음 | 자료없 음 | 자료가 없거나 분류를 위해서 충분치 않음 |
...
| 이름 | 루트 | 표적장기효과 | 값 | 종 | 시험결과 | 노출 정도 |
| --- | --- | --- | --- | --- | --- | --- |
| 제품 전체 | 자료없음 | 자료없음 | 자료가 없거나 분류를 위해서 충분치 않음 | 자료없 음 | 자료없음 | 0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 제품 전체 | None | 자료가 없거 나 분류를 위 해서 충분치 않음 | 자료없음 | 자료없음 | 자료없음 | 자료없음 |
